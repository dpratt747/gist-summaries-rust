...
This builds for macOS (ARM + Intel), Linux (x86_64), and Windows (x86_64), then creates a draft GitHub Release with all platform artifacts. Review and publish the draft from the [Releases page](../../releases).
